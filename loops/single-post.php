  ...
  <article role="article" id="post_<?php the_ID()?>" <?php post_class()?>>
      ...
      <div class="header-meta my-5 border-top border-bottom py-3 text-center text-muted">
        ...
        ?><a href="#post-comments"><?php
          ...
          printf(
            ...
            esc_html( _nx( '%1$s comment', '%1$s comments', $comment_count, 'cinema24' ) ),
    ...
    <footer class="container mt-5 border-top pt-3">
      <div class="author-bio media mt-5">
        <?php cinema24_author_avatar(); ?>
        <div class="media-body ml-3">
          <p class="h4 author-name"><?php _e('Author: ', 'cinema24'); the_author_posts_link(); ?></p>
          <?php if (cinema24_author_description()) {
            ?>
            <div class="author-description"><?php cinema24_author_description(); ?></div>
            <?php
          } ?>
          <p class="author-other-posts mb-0"><?php _e('Other posts by ', 'cinema24'); the_author_posts_link(); ?></p>
        </div>
      </div><!-- /.author-bio -->
