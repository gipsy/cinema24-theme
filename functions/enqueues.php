...
if ( ! function_exists('cinema24_enqueues') ) {
	function cinema24_enqueues() {
		...
		wp_register_style('theme', get_template_directory_uri() . '/theme/css/cinema24.css', false, null);
...
add_action('wp_enqueue_scripts', 'cinema24_enqueues', 100);
